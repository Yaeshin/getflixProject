      ...
      <div class="mx-auto w-2/3 md:w-4/6 lg:w-5/12 flex justify-center items-center border-2 rounded-md border-gray-700 py-7 mt-5 bg-gray-300 flex flex-col drop-shadow-2x shadow-lg shadow-indigo-500/40 mx-auto">
        <div class="max-w-md my-3 opacity-90">
          ...
          <form class="flex flex-col items-center" action="auth.php?action=register" method="post">
            ...
            <div class="block ">
              <label class="block text-slate-700 mb-2 text-center lg:tracking-wider text-xl" for="pseudo_inscription">Pseudo</label>
            ...
            <div class="block ">
              <label class="block text-slate-700 mt-5 text-center lg:tracking-wider mb-2 text-xl" for="password_inscription">Mot de passe</label>
            ...
            <div class="block ">
              <label class="block text-slate-700 mb-2 text-center mt-5 lg:tracking-wider text-xl "> Mot de passe</label>
            ...
            <div class="mt-4 text-center">
              ...
              <p class="lg:tracking-wider text-xl">Connexion</p>
              </a>
            </div>
          </form>
        </div>
