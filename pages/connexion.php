...
<body class="bg-slate-800">
    <div class="flex items-center justify-center h-screen">
        <div class="w-11/12 md:w-2/3 lg:w-1/3 h-10/6 bg-slate-300 p-2 my-10 mx-10 md:mx-auto shadow-2xl border-2 rounded-md bg-slate-300 flex flex-col drop-shadow-2x shadow-lg shadow-indigo-500/40">
            <div class="max-w-md my-3 opacity-90">
                ...
                <form class="grid place-content-center" action="" method="post">
                    ...
                    <div class="mt-10 sm:mt-10 flex justify-center">
                        <button class="bg-sky-500 hover:bg-sky-700 py-2 px-2 text-xl mx-auto mt-10 text-white rounded transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 shadow-lg shadow-blue-500/50" type="submit" value="Login">
                            Connexion
                        </button>
                    </div>
