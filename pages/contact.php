          ...
          <div class="p-2 w-full">
            ...
            <div class="p-2 w-full">
              <div class=" text-center mx-auto">
                ...
                <textarea id="contactMessage" name="contactMessage" required="" rows="8" class=" w-11/12 bg-white rounded border border-gray-400 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 h-32 text-base outline-none text-gray-900 py-1 px-8 resize-none leading-6 transition-colors duration-200 ease-in-out  h-full min-h-[100px] "></textarea>
              </div>
            </div>
            ...
            <div class="p-2 w-full">
              <div class="flex justify-center">
                <button type="submit" name="contactForm" value="contactForm" class="flex text-white bg-blue-500 border-0 py-3 px-6 focus:outline-none hover:bg-blue-900 rounded text-xl font-bold shadow-lg mx-0 flex-col text-center">
                  Send message
                </button>
              </div>
            </div>
