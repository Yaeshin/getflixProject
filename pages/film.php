    ...
    <main class="flex-1 flex flex-row block overflow-hidden">
            ...
            <div class="w-3/4 h-4/4 flex flex-col relative m-3 flex-shrink-0">
                <div class="flex h-2/3">
                    <div class="w-1/3 h-full rounded-2xl">
                        <div class="h-5/6 bg-gray-800 rounded-2xl flex flex-col items-center justify-center px-6">
                            <h2 class="text-white text-3xl font-bold text-center py-4">Titre du Film</h2>
                            <div class="flex flex-col justify-center">
                                <p class="text-white text-center mx-5 my-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ab nobis perferendis porro. Nisi numquam repudiandae quibusdam quis. Voluptatum modi similique aut consectetur dolores. Dolores minus assumenda asperiores aperiam aut alias?</p>
                ...
                <div class="h-1/3 overflow-y-auto mr-4 custom-scroll">
                    <!-- Ajouter my-2 aux deuxième et supérieurs -->
                    <div class="flex flex-col bg-gray-800 rounded-2xl px-2 py-1 mx-1">
